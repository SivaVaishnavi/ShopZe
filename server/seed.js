...
const masterCatalog = [
  ...
  },
  {
    ...
    description: 'Premium Mediterranean olive oil ideal for healthy cooking and salad dressings.',
  ...
  },
  {
    ...
    description: 'Fresh crunchy California almonds loaded with healthy proteins and nutrients.',
...
const seedData = async () => {
  try {
    ...
    // Insert All Master Products including all 19 GitHub Upload items
    const inserted = await Product.insertMany(masterCatalog);
    console.log(`Seeded ${inserted.length} products (including 19 GitHub uploaded images) into shopzone database!`);
    ...
    console.log('GitHub upload products & catalog seeding complete!');
    process.exit(0);
  } catch (error) {
